        ...
        try
        {
          ...
          if ((TCPResponse.startsWith("<Message>")) && (TCPResponse.endsWith("</Message>")))
          {
            ...
            if (countStringOccurrences(TCPResponse, "<Message>") == 1) {
              InternalWSClient clientEndPoint = new InternalWSClient(new URI("ws://localhost:8080/medtrac/receive"));
            ...
            else
            {
              ...
              for (int i = 0; i < countStringOccurrences(TCPResponse, "<Message>"); i++) {
                ...
                System.out.println("mTCP Response[" + i + "]: " + firstMessage);
          ...
          else if (!TCPResponse.endsWith("</Message>"))
          {
            ...
            System.out.println("TCP Response (1): " + TCPResponse1);
          }
          else
          {
            TCPResponse2 = TCPResponse;

            System.out.println("TCP Response (2): " + TCPResponse2);
            ...
            for (int i = 0; i < countStringOccurrences(TCPResponse2, "</Message>"); i++)
            {
              ...
              System.out.println("mTCP Response[" + i + "]: " + mTCPResponse);
