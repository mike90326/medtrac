...
function server_connect() {
	...
	webreceive =  new WebSocket("ws://"+server_ip+":8080/medtrac/manualreceive");
	...
	webreceive.onmessage = function(event) {
		...
		if (readTemp != "NC" && readTemp != "Error" && readTemp != "NA" && readTemp != "starting" && readTemp != "waiting") {
		...
		if (readBPhigh != "NC" && readBPhigh != "Error" && readBPhigh != "NA" && readBPhigh != "starting" && readBPhigh != "waiting") {
		...
		if (readPulse != "NC" && readPulse != "Error" && readPulse != "NA" && readPulse != "starting" && readPulse != "waiting") {
		...
		if (readSPO2 != "NC" && readSPO2 != "Error" && readSPO2 != "NA" && readSPO2 != "starting" && readSPO2 != "waiting") {
			...
			for (var i=1; i < 6; i++) {
				...
				if (localStorage.getItem("temperature"+i) !== null) {
					if (localStorage.getItem("temperature"+i) == "Error") {
						innerDoc.getElementById('temperature_'+i).value = "NA";
					}
					else {
				...
				if (localStorage.getItem("bphigh"+i) !== null) {
					if (localStorage.getItem("bphigh"+i) == "Error") {
						innerDoc.getElementById('bphigh_'+i).value = "NA";
					}
					else {
				...
				if (localStorage.getItem("bplow"+i) !== null) {
					if (localStorage.getItem("bplow"+i) == "Error") {
						innerDoc.getElementById('bplow_'+i).value = "NA";
					}
					else {
				...
				if (localStorage.getItem("pulse"+i) !== null) {
					if (localStorage.getItem("pulse"+i) == "Error") {
						innerDoc.getElementById('pulse_'+i).value = "NA";
					}
					else {
				...
				if (localStorage.getItem("spo2"+i) !== null) {
					if (localStorage.getItem("spo2"+i) == "Error") {
						innerDoc.getElementById('spo2_'+i).value = "NA";
					}
					else {
		...
		if(elem2) {
			for (var i=1; i < 6; i++) {
				if (localStorage.getItem("startdatetime"+i) !== null) {
					innerDoc.getElementById('time_'+i).textContent = localStorage.getItem("startdatetime"+i);
				}
				if (localStorage.getItem("temperature"+i) !== null) {
					if (localStorage.getItem("temperature"+i) == "Error") {
						innerDoc.getElementById('temp_'+i).textContent = "NA";
					}
					else {
						innerDoc.getElementById('temp_'+i).textContent = localStorage.getItem("temperature"+i);
					}
				}
				if (localStorage.getItem("bphigh"+i) !== null) {
					if (localStorage.getItem("bphigh"+i) == "Error") {
						innerDoc.getElementById('bph_'+i).textContent = "NA";
					}
					else {
						innerDoc.getElementById('bph_'+i).textContent = localStorage.getItem("bphigh"+i);
					}
				}
				if (localStorage.getItem("bplow"+i) !== null) {
					if (localStorage.getItem("bplow"+i) == "Error") {
						innerDoc.getElementById('bpl_'+i).textContent = "NA";
					}
					else {
						innerDoc.getElementById('bpl_'+i).textContent = localStorage.getItem("bplow"+i);
					}
				}
				if (localStorage.getItem("pulse"+i) !== null) {
					if (localStorage.getItem("pulse"+i) == "Error") {
						innerDoc.getElementById('pulse_'+i).textContent = "NA";
					}
					else {
						innerDoc.getElementById('pulse_'+i).textContent = localStorage.getItem("pulse"+i);
					}
				}
				if (localStorage.getItem("spo2"+i) !== null) {
					if (localStorage.getItem("spo2"+i) == "Error") {
						innerDoc.getElementById('spo2_'+i).textContent = "NA";
					}
					else {
						innerDoc.getElementById('spo2_'+i).textContent = localStorage.getItem("spo2"+i);
					}
				}
			}
		}
